  ...
  },
  {
    ...
    optionList: [
      ...
      },
      {
        ...
        description: 'Specify a field to be used as _id. If `hash` is specified the object hash will be used',
      },
      {
        name: 'uris',
      ...
      },
      {
        ...
        description: 'Host to stream to. [DEFAULT:localhost]',
      },
      {
        name: 'port',
        typeLabel: '[underline]{PORT}',
        description: 'Port to stream to. Defaults to 9500 (elastic) or 27017 (mongo)',
      },
      {
        name: 'help',
